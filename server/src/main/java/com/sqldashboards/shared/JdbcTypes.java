...
public enum JdbcTypes {
	...
	KDB_STREAMING("Kdb_Streaming", "kx.jdbc", 5000, "jdbc:q:{host}:{port}", "http://kx.com", "", "") {
	...
	PROTON("Proton", "com.proton.jdbc.ProtonDriver", 3218, "jdbc:ch://{host}:{port}/{database}", "http://github.com/timeplus-io/proton", "", ""),	
	...
	CLICKHOUSE_COM("ClickHouse.com","com.clickhouse.jdbc.ClickHouseDriver",8123,"jdbc:ch:{host}:{port}[/{database}]","https://github.com/ClickHouse/clickhouse-java","maven:/com.clickhouse:clickhouse-jdbc:RELEASE[0.4.6]","com/clickhouse/clickhouse-jdbc/0.4.6/clickhouse-jdbc-0.4.6.jar"),
	...
	DOLPHINDB("DolphinDB","com.dolphindb.jdbc.Driver",9200,"jdbc:dolphindb://{host}:{port}","https://dolphindb.com/","maven:/com.dolphindb:jdbc:1.30.22.3","com/dolphindb/jdbc/1.30.22.3/jdbc-1.30.22.3-jar-with-dependencies.jar"),
