...
var EChartsReactCore = /** @class */ (function (_super) {
    ...
    EChartsReactCore.prototype.updateEChartsOption = function () {
        var _a = this.props, option = _a.option, 
        _b = _a.notMerge, notMerge = _b === void 0 ? false : _b, 
        _c = _a.lazyUpdate, lazyUpdate = _c === void 0 ? false : _c, 
        _e = _a.replaceMerge, replaceMerge = _e === void 0 ? [] : _e, 
        showLoading = _a.showLoading, 
        _d = _a.loadingOption, loadingOption = _d === void 0 ? null : _d;
